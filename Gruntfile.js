...
grunt.registerTask('express-keepalive', 'Keep grunt running', function() {
  ...
  grunt.registerTask('build',['jshint','clean:before','sass','dom_munger','ngtemplates','cssmin','svgmin','concat','ngmin','uglify','copy','htmlmin','imagemin','clean:after']);
  grunt.registerTask('serve', ['dom_munger:read', 'jshint', 'sass', 'express', 'watch', 'express-keepalive']);
